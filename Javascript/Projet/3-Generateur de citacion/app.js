...
//index de la citation afficher actuellement (0 par defaut)
let index = 0
//contient un nombre aleatoire
let nombreAleatoire

//En cliquant sur "Nouvelle citation"....
btn.addEventListener('click', () => {

    //.....On tire un nombre au hasard.....
    do {
        nombreAleatoire = Math.floor(Math.random() * (citations.length-1))
    console.log(nombreAleatoire)

    //.....tant qu'il est difference de l'index actuel
    } while (index == nombreAleatoire);

    //....l'index changera aleatoirement....
    index = nombreAleatoire

    //...donc la citation et l'auteur changeront alleatoirement en fonction de l'index
    quote.textContent = citations[index][0]
    auteur.textContent = citations[index][1]
